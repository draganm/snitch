...
}{"href": "#", "className": "navbar-brand"}, Children: []*reactor.DisplayModel{&reactor.DisplayModel{Text: "Snitch"}}}}}}}, &reactor.DisplayModel{Element: "bs.Navbar.Collapse", Attributes: map[string]interface {
